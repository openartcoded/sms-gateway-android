...
@Composable
fun SmsGatewayMainPage(defaultEndpoint: String, modifier: Modifier = Modifier) {
...
@Composable
fun SmsGatewayMainPagePreview() {
    SmsGatewayTheme {
        SmsGatewayMainPage(defaultEndpoint = "http://google.com")
    }
}
